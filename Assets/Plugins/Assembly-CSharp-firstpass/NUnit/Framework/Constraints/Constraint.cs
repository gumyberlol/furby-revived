...
namespace NUnit.Framework.Constraints
{
	public abstract class Constraint : IResolveConstraint
	{
		...
		{
			return (builder != null) ? builder.Resolve() : this;
		}
		...
		public override string ToString()
		{
			...
			return (builder != null) ? string.Format("<unresolved {0}>", stringRepresentation) : stringRepresentation;
		}
		...
		{
			return new DelayedConstraint((builder != null) ? builder.Resolve() : this, delayInMilliseconds);
		}

		public DelayedConstraint After(int delayInMilliseconds, int pollingInterval)
		{
			return new DelayedConstraint((builder != null) ? builder.Resolve() : this, delayInMilliseconds, pollingInterval);
		}
		...
		{
			return new NotConstraint((constraint != null) ? ((IResolveConstraint)constraint).Resolve() : new NullConstraint());
		}
	}
}
