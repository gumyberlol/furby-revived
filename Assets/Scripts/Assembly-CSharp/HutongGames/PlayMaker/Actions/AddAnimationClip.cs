	...
	public class AddAnimationClip : FsmStateAction
	{
		...
		private void DoAddAnimationClip()
		{
			...
			if (!(animationClip == null))
			{
				...
				{
					ownerDefaultTarget.animation.AddClip(animationClip, animationName.Value);
				}
				else
				{
					ownerDefaultTarget.animation.AddClip(animationClip, animationName.Value, firstFrame.Value, lastFrame.Value, addLoopFrame.Value);
				}
			}
		}
	}
