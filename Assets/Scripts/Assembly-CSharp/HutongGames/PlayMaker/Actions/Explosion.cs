...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class Explosion : FsmStateAction
	{
		...
		private void DoExplosion()
		{
			...
			{
				if (collider.rigidbody != null && ShouldApplyForce(collider.gameObject))
				{
					collider.rigidbody.AddExplosionForce(force.Value, center.Value, radius.Value, upwardsModifier.Value, forceMode);
				}
			}
		}
