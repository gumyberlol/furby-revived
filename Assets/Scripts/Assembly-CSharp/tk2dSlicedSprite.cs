...
public class tk2dSlicedSprite : tk2dBaseSprite
{
	...
	{
		if (base.renderer.sharedMaterial != base.Collection.spriteDefinitions[base.spriteId].materialInst)
		{
			base.renderer.material = base.Collection.spriteDefinitions[base.spriteId].materialInst;
		}
	}
